...
export default function App() {
  ...
  const handleStart = () => {
    ...
    audioRef.current.play().catch(() => console.log("Audio file missing in /public"));
    setIsUnlocked(true);
  };
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] font-sans overflow-hidden">
      ...
      <AnimatePresence>
        {!isEntryComplete && (
          ...
          >
            ...
            >
              <div className="absolute top-[15%] left-1/2 -translate-x-1/2 font-mono text-[100px] font-black text-black/10 select-none italic">666</div>
      ...
      <header className="bg-[#7f1d1d] text-[#f1f5f9] p-5 border-b-8 border-[#18181b]">
        <h1 className="font-mono font-black text-2xl uppercase italic">Vankila-Punk // Registry</h1>
      </header>
      <main className="p-10 max-w-4xl mx-auto">
        <div className="bg-white border-4 border-[#18181b] p-10 shadow-[12px_12px_0px_0px_#18181b]">
          <h2 className="text-5xl font-black uppercase mb-4">Entry Successful</h2>
          <p className="text-xl">The solitary door protocol has been cleared.</p>
        </div>
      </main>
    </div>
  );
